...
export class UserService {
   ...
   * @throws ApiError
   */
  public createUser(user: user): CancelablePromise<user | general_error> {
    return this.httpRequest.request({
      method: "POST",
      url: "/users",
      body: user,
   ...
   * @throws ApiError
   */
  public showUser(userId: string): CancelablePromise<user | general_error> {
    return this.httpRequest.request({
      method: "GET",
      url: "/users/{user_id}",
      path: {
   ...
   * @throws ApiError
   */
  public deleteUser(userId: string): CancelablePromise<general_error> {
    return this.httpRequest.request({
      method: "DELETE",
      url: "/users/{user_id}",
      path: {
